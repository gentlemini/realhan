...
const STORAGE_KEY  = 'hk_rom_sale_layout_v1';
const COUNTER_KEY  = 'hk_property_counter';
const PROPERTY_PREFIX = 'rmsm';
          ...
          <div className={styles.previewDataCol}>
            ...
            <div className={styles.previewDataScroll}>
              <div className={styles.previewDataHeader}>
                <div className={styles.previewDataHeaderSub}>원룸 매매</div>
...
let uploadedUrls = [];
    ...
    try {
      ...
      const url     = isEdit ? `/api/rom-sale/${pageId}` : '/api/rom-sale/register';
    ...
    <div className={styles.page}>
      <div className={styles.topbar}>
        <div className={styles.topLeft}>
          ...
          <span className={styles.topTitle}>원룸 매매 — {editMode ? '레이아웃 편집' : isEdit ? '수정' : '등록'}</span>
        </div>
      ...
      <div className={`${styles.canvas} ${showAddPanel ? styles.canvasShift : ''}`}>
                  {!editMode && <BuildingLookup 종류="원룸" 거래유형="매매" onApply={applyBuildingData} />}
