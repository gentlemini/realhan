...
const FIELD_ORDER = new Map([
  ['매물고유번호',    1], ['매물제목_특징',   2], ['매물분류',      3],
  ['세부유형',      4], ['분양구분',      5], ['분양가유무',     6],
  ['거래종류',      7], ['세부지목',      8], ['면적_㎡',       9],
  ['건물유형',      10], ['건축물용도_분류', 11], ['소재지',       11],
  ['번지',         12], ['상세주소',      13], ['지번노출여부',   14],
  ['아파트명',      21], ['오피스텔명',     22], ['평형',         23],
  ['동',           24], ['호수',         25],
  ['연면적_㎡',     31], ['대지면적_㎡',   32], ['건축면적_㎡',   33],
  ['공급면적_㎡',   34], ['전용면적_㎡',   35], ['대지지분_㎡',   36],
  ['대지지분',      37], ['임대계약면적_㎡', 38], ['예상면적_㎡',   39],
  ['매매가격_만원',  46], ['전세가격_만원',  47], ['보증금_만원',   48],
  ['월세_만원',    49], ['분양금액_만원',  50], ['프리미엄_만원',  51],
  ['옵션가격_만원',  52], ['납입중도금_만원', 53], ['이주비_만원',   54],
  ['현전세보증금_만원', 55], ['현전월세_만원',  56], ['현보증금_만원',  57],
  ['현월세_만원',   58], ['전보증금_만원',  59], ['전월세_만원',   60],
  ['관리비_만원',   61], ['관리비',       62], ['관리비_상세',    62],
  ['관리비_포함항목', 62], ['관리금_만원',   63], ['권리금_만원',   63],
  ['시설금_만원',   64], ['환관리비_만원',  65], ['월관리비_만원',  66],
  ['융자금_만원',   67], ['입주가능일',    71],
  ['해당층',       81], ['총층수',       82], ['지상층수',     83],
  ['지하층수',     84], ['방수',         85], ['욕실수',       86],
  ['화장실수',     87], ['방향_기준',    88], ['방향',        89],
  ['현관유형',     90], ['방거실형태',   91], ['세대가구수',   92],
  ['복층여부',     93], ['주차가능여부',  101], ['총주차대수',   102],
  ['세대당주차대수', 103], ['업포수',       104], ['사무실수',     105],
  ['점포수',       106], ['위반건축물여부', 111], ['건물용도',     112],
  ['건축물용도',   113], ['건축구조',     114], ['사용승인일',   115],
  ['사용검사일',   116], ['사용전력',     117], ['난방시설',     121],
  ['난방연료',     122], ['용도지역',     131], ['국토이용',     132],
  ['도시계획',     133], ['건축허가',     134], ['토지거래허가',  135],
  ['진입도로',     136], ['현업종',      141], ['추천업종',     142],
  ['현재용도',     143], ['추천용도',     144], ['매물상세정보',  151],
  ['매물등록일',   152], ['에어컨',      161], ['일반옵션',     162],
  ['보안옵션',     163], ['기타옵션',     164], ['주차옵션',     165],
]);
