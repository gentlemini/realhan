export const DEFAULT_FIELDS = [
  ...
  { id: 'category',        label: '매물분류',                 type: 'fixed',      value: '재개발' },
  { id: 'sub_type',        label: '세부유형',                 type: 'radio',      colSpan: 3, options: ['아파트', '연립', '단독주택', '다세대주택', '다가구주택', '기타'] },
  ...
  { id: 'expected_area',   label: '예상면적 (㎡)',            type: 'area',     colSpan: 1 },
