export const DEFAULT_FIELDS = [
  ...
  { id: 'building_type',  label: '건물유형',         type: 'radio',          colSpan: 2, options: ['단독', '다가구', '상가주택', '기타'] },
  { id: 'supply_area',    label: '공급면적 (㎡)',    type: 'area',         colSpan: 1 },
  { id: 'exclusive_area', label: '전용면적 (㎡)',    type: 'area',         colSpan: 1 },
  { id: 'land_share',     label: '대지지분',         type: 'text',           colSpan: 1 },
  ...
  { id: 'room_type',      label: '방거실형태',       type: 'radio',          colSpan: 1, options: ['오픈형', '독립형'] },
