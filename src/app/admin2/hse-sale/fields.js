export const DEFAULT_FIELDS = [
  ...
  { id: 'curr_jeonse',       label: '현보증금 (만원)',          type: 'number',     colSpan: 1 },
  { id: 'curr_monthly_rent', label: '현월세 (만원)',            type: 'number',     colSpan: 1 },
