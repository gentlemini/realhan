export const DEFAULT_FIELDS = [
  ...
  { id: 'category',              label: '매물분류',                 type: 'radio',      colSpan: 2, options: ['대형사무실', '중소형사무실', '오피스텔', '지식산업센터'] },
  ...
  { id: 'manager_fee',           label: '관리금 (만원)',            type: 'number',     colSpan: 1 },
  ...
  { id: 'offices_count',         label: '사무실수',                 type: 'number',     colSpan: 1 },
